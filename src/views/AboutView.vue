    ...
    <article data-page="about">
      ...
      <section>
        ...
        <div v-show="activeTab === 3">
          <div class="text-white leading-relaxed text-md md:text-lg">
            🎓 <strong>Istruzione</strong><br>
            Diploma Scientifico – Liceo Scientifico Galileo Galilei, Lamezia Terme (2019 – 2024)<br>
            Laurea Triennale in Informatica – Università della Calabria (UNICAL) (2024 – in corso)
          </div>
        </div>
