      ...
      <section class="text-sm md:text-lg text-justify flex flex-col gap-4 md:flex-row md:gap-8 md:justify-left md:items-center">
        ...
        <div class="md:w-7/12">
          <p class="mb-3 md:mb-7 fadein-left fadeins-1">
            &nbsp; &nbsp; &nbsp; Studente estroverso e creativo, appassionato di informatica, film e musica. Mi piace esprimermi attraverso la tecnologia e le arti digitali. Mi piace cucinare e imparare cose nuove.
          </p>
          <p class="mb-3 fadein-left fadeins-2">
            🎓 <strong>Istruzione</strong><br>
            Diploma Scientifico – Liceo Scientifico Galileo Galilei, Lamezia Terme<br>
            Periodo: 2019 – 2024<br>
            Laurea Triennale in Informatica – Università della Calabria (UNICAL)<br>
            Periodo: 2024 – In corso
          </p>
          <p class="mb-3 fadein-left fadeins-2">
            💡 <strong>Interessi</strong><br>
            Film e musica<br>
            ...
            <div v-for="item in tech" :key="item.id">
              <div class="item-tech flex cursor-pointer items-center gap-2 rounded border border-amber-200 px-2 py-2 hover:bg-amber-200 hover:bg-opacity-10 md:gap-3 lg:px-3">
                <div class="flex h-12 w-12 items-center justify-center p-0 lg:h-16 lg:w-16 lg:p-2 zoom-in">
                  <img :alt="item.name" loading="lazy" width="32" height="32" decoding="async" data-nimg="1" class="img-tech drop-shadow-xl transition-all duration-300 h-[65%] w-[65%] lg:h-[85%] lg:w-[85%]" :src="item.imageUrl" style="color: transparent;">
                </div>
